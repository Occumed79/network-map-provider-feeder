...
<main>
  ...
  <section class="grid cols"><div class="panel"><h2>Current Scrapy Source Counts</h2><div id="sourceCounts"></div><div id="legacySourcePanel"><h2>Legacy Source Counts</h2><div id="legacySources"></div></div></div><div class="panel"><h2>Current Diagnosis</h2><div id="diagnosis"></div></div></section>
  ...
  <section class="grid cols" id="legacySection"><div class="panel"><h2>Legacy Map Jobs</h2><div class="scroll" id="legacyJobs"></div></div><div class="panel"><h2>Legacy Errors</h2><div class="scroll" id="legacyErrors"></div></div></section>
</main>
<script>
...
async function refresh(){
  ...
  try{
    ...
    const showLegacy = Boolean(d.env && d.env.dashboardShowLegacy);
    legacySourcePanel.style.display = showLegacy ? '' : 'none';
    legacySection.style.display = showLegacy ? '' : 'none';
    legacySources.innerHTML=showLegacy ? table(['Source','Rows'],d.legacySourceCounts,r=>[esc(r.source),'<span class="mono">'+esc(r.count)+'</span>']) : '';
